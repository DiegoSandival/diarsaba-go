...
require (
	github.com/DiegoSandival/lluvia v0.0.0
...
require (
	...
	github.com/zserge/webview v0.0.0-20260309075125-cbbdee44afff // indirect
...
replace github.com/DiegoSandival/lluvia => ../lluvia-go
